...
import { IArtistDetailCardProps } from "../model/ArtistDetailCard.types";
      ...
      <div className={s.container}>
        ...
        <div className={s.info}>
          <div className={s.info__header}>
            <Title Tag="h2" className={clsx(s.text, s.info__title)}>{artist.name}</Title>
          ...
          <div className={s.info__contacts}>
            {artist.contacts.length > 0 && artist.contacts.map((contact) => (
              ...
              <div className={s.socials}>
                {artist.socials.map((social) => (
                  <a 
                    ...
                    style={{
                      backgroundImage: social.label === 'Вконтакте' 
