import { Text, Title, ButtonUI, AccentContainer } from "@/shared/ui";
import Gallery from "../components/Gallery/Gallery";
import { ProductDescriptionProps } from "../../model/ProductDescription.type";
          ...
          {variant === "merch" && (
            <>
              ...
              {product.sizes && product.sizes.length > 0 && (
                <SizeRange sizes={product.sizes} onClick={selecSize} />
              )}
              <ButtonUI
                variant="primary"
                size="standart"
