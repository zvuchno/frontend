...
import { type TrackCardProps } from "./TrackCard.type";
    ...
    <div className={s.container}>
      <div className={s.card}>
        ...
        <div className={s.text}>
          {duration ? formatDuration(duration) : price ? `${price} руб` : null}
        </div>
      </div>
