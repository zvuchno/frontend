...
const FiltersGroup = ({ title, items, filterType, isSecondary, isClearFilters, isActiveFilter, buildLink, clearFilters }: FiltersGroupProps) => {

  const handleClickOnFilter = (e: React.MouseEvent<HTMLAnchorElement> ,value: string) => {
